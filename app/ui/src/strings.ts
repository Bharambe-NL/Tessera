...
export const COPY = {
  ...
  mapChecked: 'Checked',
  mapMastered: 'Known',
  mapDecayed: 'Gone stale',
  mapMissionOnly: 'This mission only',
  mapBack: 'Back to the map',
  mapStateUnseen: 'not started',
  mapStateExposed: 'seen',
  mapStateRated: 'rated',
  mapStateChecked: 'checked',
  mapStateMastered: 'known',
  mapStateDecayed: 'gone stale',
  mapScore: 'Score',
  mapClaimed: 'From what you said, that is',
  mapUnchecked: 'No check has confirmed it.',
  mapAtLevel: 'at level',
  mapNoScore: 'No check has put a score on this yet.',
  mapLastSeen: 'Last worked on',
  mapNoEvidence: 'Nothing has touched this yet.',
  mapRateHead: 'How well do you know this?',
  mapRating0: 'Never heard of it',
  mapRating1: 'Heard of it',
  mapRating2: 'Can explain it',
  mapRating3: 'Can apply it',
  mapLinkedHead: 'What covers it',
  mapNoLinks: 'No card or page covers this yet.',
  mapStartLesson: 'Start a lesson',
