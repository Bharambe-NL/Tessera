...
|---|---|---|---|
| id | ulid | sys | |
| class | enum web, regulatory, local_document, structured_query, user_supplied | req | Doctrine hierarchy ranks these. |
| title | string | req | |
...
| relation | enum explains, mentions, defines, contradicts, related_to | req | |
